...
argparser = ArgumentParser(prog='photometric_diagrams.py', description='>> Interactive CCD and CMD diagrams <<\n\n \
Requires Python 2.7 with:\n  * numpy\n  * argparse\n  * matplotlib\n\n', 
epilog='Copyright (c) 2017 Przemysław Bruś', formatter_class=tefo)
argparser.add_argument('input_file', help='must contain columns with data and a header')
argparser.add_argument('--col', help="columns which should be used to create \
the diagram\nNegative value reverses range's axis. There is no limit to the diagrams", \
